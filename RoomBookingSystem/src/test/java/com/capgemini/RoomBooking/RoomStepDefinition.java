package com.capgemini.RoomBooking;

import org.openqa.selenium.WebDriver;
import org.openqa.selenium.chrome.ChromeDriver;
import org.openqa.selenium.support.PageFactory;

import com.capgemini.Page.RoomPageFactory;
...
public class RoomStepDefinition {
	...
	private RoomPageFactory	 pageBean ;
	@Before
	...
	public void user_is_on_Conference_room_booking_page() throws Throwable {
		...
		driver.get("D:\\SatishTrainingData\\PaperSet\\BDD_Selenium\\SET08\\ConferenceRegistartion.html");
		driver.manage().window().maximize();
		pageBean= new RoomPageFactory();
	...
	/*	driver.findElement(By.id("txtFirstName")).sendKeys("Satish");
		driver.findElement(By.linkText("Next")).click();*/
	...
	public void user_select_Next_link_without_entering_Email() throws Throwable {
		driver.switchTo().alert().dismiss();
		/*driver.findElement(By.id("txtLastName")).sendKeys("Mahajan");
		driver.findElement(By.linkText("Next")).click();*/
	...
	public void user_select_Next_link_after_entering_invalid_Email_address() throws Throwable {
		driver.switchTo().alert().dismiss();
	/*	driver.findElement(By.id("txtEmail")).sendKeys("satish.a.mahajan capgemini.com");
		driver.findElement(By.linkText("Next")).click();*/
